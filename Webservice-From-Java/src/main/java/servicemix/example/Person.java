...
@WebService
@XmlSeeAlso({servicemix.example.types.ObjectFactory.class})
public interface Person {

    @RequestWrapper(localName = "GetPerson", className = "servicemix.example.types.GetPerson")
    @ResponseWrapper(localName = "GetPersonResponse", className = "servicemix.example.types.GetPersonResponse")
